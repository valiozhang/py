...
# Form implementation generated from reading ui file 'MainWinHorizentalLayout.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):#往哪一个主窗口创建类
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(1320, 875)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(260, 320, 964, 291))
        ...
        self.widget.setGeometry(QtCore.QRect(310, 130, 697, 42))
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1320, 34))
