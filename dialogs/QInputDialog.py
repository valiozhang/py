...
QInputDialog.getItem # 显示输入列表，传入列表或元组
QInputDialog.getText # 显示录入文本
QInputDialog.getInt  # 显示计数器控件，输入整数
"""
