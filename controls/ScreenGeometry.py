...
def onClick_Button():
    ...
    print("widget.frameGeometry().width() = %d" % widget.frameGeometry().width())  #302 (窗口（包含了标题栏和边框）宽度)
    print("widget.frameGeometry().height() = %d" % widget.frameGeometry().height())  #293 窗口（包含了标题栏和边框）高度）
